...
use Odutola\Payant\Exceptions\IsNullException;
use Odutola\Payant\Exceptions\PaymentVerificationFailedException;
...
class Payant
{
    ...
    /**
     * Issue Secret Key from your Payant Dashboard
     * @var string
     */
    protected $secretKey;
    ...
    /**
     *  Response from requests made to Payant
     * @var mixed
     */
    protected $response;
    ...
    /**
     * Authorization Url - Payant payment page
     * @var string
     */
    ...
    {
        $this->baseUrl = Config::get('payant.paymentUrl');
    }

    /**
     * Get secret key from Payant config file
     */
    public function setKey()
    {
        $this->secretKey = Config::get('payant.secretKey');
    }
     ...
     * Initiate a payment request to Payant
    ...
    public function makePaymentRequest( $data = null)
    {
        if ( $data == null ) {
            $data = [
                ...
                /*
                * to allow use of metadata on Payant dashboard and a means to return additional data back to redirect url
    ...
    /**
     * Hit Payant Gateway to Verify that the transaction is valid
     */
    ...
    /**
     * Fluent method to redirect to Payant Payment Page
     */
    ...
    /**
     * Get all the plans that you have on Payant
     * @return array
     */
    ...
    /**
     * Get all the subscriptions made on Payant.
     *
     * @return array
     */
